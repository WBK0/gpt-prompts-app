  ...
  return (
    <div className='flex w-full space-x-2'>
      <div className="flex-grow">
        <input type="text" value={tagInput} onChange={handleTagInputChange} className={`w-full px-3 py-2 border rounded-md font-gilroyMedium focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent ${tagsError ? 'border-red-500 border-2' : 'border-gray-400'}`} />
      </div>
