    ...
    <div className="flex justify-center items-center h-screen">
      <div className="flex flex-col items-center justify-center w-96">
        ...
        <form className="flex flex-col space-y-4 w-full" onSubmit={handleSubmit}>
          <input type="text" placeholder="Firstname" className=" rounded-lg px-4 py-2 focus:outline-none focus:ring-2 focus:ring-blue-400 font-gilroyBold" name="firstname" onChange={handleWrite} value={userData.email}/>
          <input type="text" placeholder="Lastname" className=" rounded-lg px-4 py-2 focus:outline-none focus:ring-2 focus:ring-blue-400 font-gilroyBold" name="lastname" onChange={handleWrite} value={userData.email}/>
