  ...
  return (
    <div className="flex justify-center items-center h-screen">
      <div className="flex flex-col items-center justify-center w-96 px-3">
        ...
        <button className="bg-white text-black rounded-2xl px-4 py-2 focus:outline-none focus:ring-2 focus:ring-blue-400 w-full mb-5 font-gilroyBold relative h-10" onClick={() => signIn('google')}>
        ...
        <form className="flex flex-col space-y-4 w-full" onSubmit={handleSubmit}>
          ...
          <button 
            type="submit" 
            className="bg-blue-500 text-white rounded-md px-4 py-2 focus:outline-none focus:ring-2 focus:ring-blue-400 font-gilroyBold">
            {
              isSubmitting 
              ? 
