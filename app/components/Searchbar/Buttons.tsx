  ...
  return (
    <div className='flex flex-col items-center'>
      <div className='flex flex-col sm:flex-row mt-6'>
        ...
        <button className='bg-blue-600 hover:bg-blue-700 text-white font-medium py-2 px-4 rounded-lg shadow-md transition duration-300 ease-in-out transform hover:-translate-y-1 hover:scale-110'>
          Search prompts
        </button>
      </div>
    </div>
